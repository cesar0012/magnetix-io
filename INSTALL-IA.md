...
**Repositorio**: `https://github.com/cesar0012/magnetix-io` (público, rama `main`,
...
2. **Aplicación**: crea una app tipo **repositorio público** apuntando a
   `https://github.com/cesar0012/magnetix-io` (rama `main`, build pack
...
```bash
git clone https://github.com/cesar0012/magnetix-io.git vocero && cd vocero
cp .env.example .env
